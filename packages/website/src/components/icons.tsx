// Clean SVG icon library — stroke (lucide-style) + fill (brand logos)
// All stroke icons: 24x24, 1.5px stroke, round caps/joins, no fill
// All brand icons: 24x24, filled
...
export function ListChecksIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...S} className={className}>
...
export function GitForkIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...S} className={className}>
...
export function RouteIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...S} className={className}>
      ...
      <path d="M9 19h8.5c.4 0 .9-.1 1.3-.4.4-.3.7-.6.9-1l2.1-3.9" />
      <path d="m6 16-1-1" />
      <circle cx="18" cy="5" r="3" />
      <path d="M15 5H6.5c-.4 0-.9.1-1.3.4-.4.3-.7.6-.9 1L2.2 10.3" />
    </svg>
  );
}
...
export function ApiIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...S} className={className}>
...
export function MatrixIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M.632.55v22.9H2.28V24H0V0h2.28v.55zm7.043 7.26v1.157h.033a3.312 3.312 0 0 1 1.117-1.024c.433-.245.936-.365 1.5-.365.54 0 1.033.107 1.481.314.448.208.785.582 1.02 1.108.254-.374.6-.706 1.034-.992.434-.287.95-.43 1.546-.43.453 0 .872.056 1.26.167.388.11.716.286.993.53.276.245.489.559.646.951.152.392.23.863.23 1.417v5.728h-2.349V11.52c0-.286-.01-.559-.032-.812a1.755 1.755 0 0 0-.18-.66 1.106 1.106 0 0 0-.428-.448c-.194-.11-.457-.166-.785-.166-.328 0-.59.063-.79.189a1.201 1.201 0 0 0-.46.498 2.015 2.015 0 0 0-.2.715 6.84 6.84 0 0 0-.043.793v4.826H11.1V11.62c0-.252-.005-.5-.02-.748a1.944 1.944 0 0 0-.144-.688 1.076 1.076 0 0 0-.415-.503c-.194-.125-.476-.19-.845-.19-.11 0-.252.026-.425.08a1.296 1.296 0 0 0-.473.298 1.687 1.687 0 0 0-.37.602c-.1.257-.154.588-.154.993v4.833H6.906V7.81zm15.693 15.64V.55H21.72V0H24v24h-2.28v-.55z" />
    </svg>
  );
}
